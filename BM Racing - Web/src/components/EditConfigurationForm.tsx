...
const EditConfigurationForm = ({ route, id, onConfigurationEdited }: { route: string, id: number|null, onConfigurationEdited: (id: number, power_weight_ratio: number) => void }) => {
  ...
  useEffect(() => {
    const fetchConfiguration = async () => {
      try {
        const response = await api.getConfigurationById(Number(id));
        ...
        formik.setValues({
          ...
          power_weight_ratio: configuration.power_weight_ratio,
          aero_upgrade: configuration.aero_upgrade,
          excessive_modifications: configuration.excessive_modifications,
          excessive_chamber: configuration.excessive_chamber,
          liquid_leakage: configuration.liquid_leakage,
